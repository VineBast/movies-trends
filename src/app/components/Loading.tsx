    ...
    return (
        <>
            <div className="mockup-code">
                ...
                <pre data-prefix="~"><code>proposing the real trend of US cinema releases of the week</code></pre>
                <pre data-prefix="~"><code>scrapping different website specializing in cinema.</code></pre>
